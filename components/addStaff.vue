<template>
  <md-card style="width:100%;">
    ...
    <md-card-header>
      ...
      <div class="md-subhead">添加一个新的职工</div>
    </md-card-header>
      ...
      <form style="width:100%;">
        <md-layout md-gutter="16">
          ...
          <md-layout md-flex="30" md-flex-offset="5">
            <div class="inputCon">
              <md-radio v-model="form.sex" id="my-test4" name="my-test-group2" md-value="1" class="md-primary">男
              </md-radio>
              <md-radio v-model="form.sex" id="my-test5" name="my-test-group2" md-value="0" class="md-primary">女
              </md-radio>
            </div>
